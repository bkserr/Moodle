...
<head>
   ...
   <!-- Bootstrap scripts-->
    ...
    <link href=<?php echo base_url("dist/css/dropzone.css");?> type="text/css" rel="stylesheet" />
...
<body class="nav-md">
    ...
    <div class="main_container">
      ...
      <div class="right_col" role="main" style="min-height: 1161px;">
        ...
        <?php
          ...
          echo form_open("dropzone/upload", $form_attr);
        ?>
        <?php
  ...
  <script src=<?php echo base_url('dist/js/dropzone/dropzone.min.js'); ?>></script>
</body>
</html>
<?php
}
